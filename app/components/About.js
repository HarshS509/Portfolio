...
import profilePic from "../../public/extraImages/abstract.jpg";
  ...
  return (
    ...
    >
      ...
      <Image
        ...
        alt="Harsh Sojitra profile image"
        priority={false}
        placeholder="blur"
      />
      ...
      <div className="px-0 md:px-8 lg:px-20 text-black dark:text-white">
        ...
        <p className="text-sm md:text-base lg:text-lg font-light md:px-7 pt-3 font-outfit">
          ...
          <br />
          <br />I engage with the developer community, exchanging ideas and
          staying updated on industry trends.
          <br /> <br /> Alongside my tech endeavors, I am an avid reader and
          enjoy exploring a variety of genres, all while enjoying a{" "}
          <span className="text-blue-500 font-semibold">
            fresh cup of coffee!
          </span>
        </p>
